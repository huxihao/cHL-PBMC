# Plot a heatmap based on VorteX outputs

## Load data

```{r}
data = read.table('../../vortex-analysis/vortex-clusters/HDvsCD_CD3+_12k_Apr2019_allSCs.csv.gz', sep=',', header=T)
prefix_out = 'CD3+ Donor vs New - '
```
...
#colnames(dataFromXshift)=gsub("(^.+)[.]([^_]+)$","\\1",colnames(dataFromXshift))
